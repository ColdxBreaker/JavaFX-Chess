    ...
    public Piece(boolean isBlack, String chessPieceName) {
        ...
        if (isBlack) {
            ...
            try { // If the chess piece can't be found
                pieceImage = new Image("file:" + "C:\\Users\\Chris (Local)\\Documents\\workspace\\CompSci_Chris\\src\\TheNewICS4UR\\Summative\\Chess\\" + chessPieceName + "B.png");
            } catch (Exception e) {
            ...
            try { // Exception handling in the event that the image is not found
                ...
                pieceImage = new Image("file:" + "C:\\Users\\Chris (Local)\\Documents\\workspace\\CompSci_Chris\\src\\TheNewICS4UR\\Summative\\Chess\\" + chessPieceName + "W.png");
            } catch (Exception e) {
                System.out.println(e.getMessage());
            }
        }
